<?php
//Your keys go here
define('PRIVATE_KEY','KHazu488rEYz2BbO9JDa'); //PRIVATE KEY
define('PUBLIC_ID','51316c8816d3127b7b00001c'); //PUBLIC ID
...
{
    $html = '<script src="//rabbit.cs.pdx.edu/headwinds/application/js/metacaptcha.js"></script>';
    if ($formID===null)
    {
